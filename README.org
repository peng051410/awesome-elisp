...
- [[#resources][Resources]]
   ...
   - [[#advanced][Advanced]]
      ...
      - [[#the-emacs-package-developers-handbook][The Emacs Package Developer’s Handbook]]
...
*** DONE [#A] (Almost) All You Need to Know About Variables
...
*** [#A] Emergency Elisp
:LOGBOOK:
- Note taken on [2024-01-17 Wed 16:37] \\
  I like simple OOP
:END:
...
*** [#A] ergoemacs - Practical Emacs Lisp
:LOGBOOK:
- Note taken on [2024-01-17 Wed 16:39] \\
  李杀的lisp教程
:END:
...
*** [#A] ElispCheatSheet
:LOGBOOK:
- Note taken on [2024-01-17 Wed 17:01] \\
  深入理解了lambda的使用
:END:
